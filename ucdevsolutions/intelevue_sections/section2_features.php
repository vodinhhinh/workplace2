...
<h2 class="text-center wowload fadeInUp">Features</h2>  
  <div class="row">
  <div class="col-sm-6 wowload fadeInLeft">
	<div class="well clearfix">
		<h4 class="text-center"><i class="fa fa-th-large"></i>No Professionals Needed!</h4>
		<img class="img-responsive center-block img-features" src="<?php echo $url ?>images/features/benefit2.jpg">
		<p class="description">
  ...
  <div class="col-sm-6 wowload fadeInRight">
	<div class="well clearfix">
		...
		<img class="img-responsive center-block img-features" src="<?php echo $url ?>images/features/feature2.jpg">
		<p class="description">
  ...
  <div class="col-sm-6 wowload fadeInLeft">
	...
	<img class="img-responsive center-block img-features" src="<?php echo $url ?>images/features/benefit3.jpg">
		<p class="description">
  ...
  <div class="col-sm-6 wowload fadeInRight">
	<div class="well clearfix">
		...
		<img class="img-responsive center-block img-features" src="<?php echo $url ?>images/features/benefit4.jpg">
		<p class="description">
