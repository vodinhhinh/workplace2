...
<img class="img-responsive center-block" src="<?php echo $url ?>images/placeholder2.jpg">
</div>
<!-- Cirlce Starts -->
...
<p class=" wowload fadeInUp">With UC Dev Solution's Custom Development, your needs can become your reality.
 ...
 gadget, tool, or any other SOLUTION you may need.</p>  
  ...
  <h4 class="text-center"><i class="fa fa-th-large"></i>IPIVR</h4>
	<div class="col-sm-8 wowload fadeInLeft">
		...
		<p>
			...
			<br><br>
			For more information about custom call scripting see our <a href="<?php echo $url ?>solutions/call_CVP.php">CVP</a> page.
			<br><br>
